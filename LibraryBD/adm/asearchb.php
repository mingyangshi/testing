        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
                <div class="col-sm-8 col-sm-offset-2">
                    <br/>
                    <br/>
                    <form role="search" name="form1" method="POST" action="asearchbresult.php">
                        <div class="form-group">
                            ...
                            <!--<label for="inputbookid" class="col-sm-2  control-label">图书管理</label>-->
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="searchword" placeholder="请输入图书信息" name="searchword">
                            </div>
                            <button type="submit" class="btn btn-default" id="searchbook"><a href="asearchbresult.php">查找图书</a></button>
                            <button type="button" class="btn btn-default" id="addbook"><a href="aaddbook.php">图书入库</a></button>
                        </div>
