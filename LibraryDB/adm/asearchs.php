        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
                <div class="col-sm-8 col-sm-offset-2">
                    <br/>
                    <br/>
                    <form role="search" name="form1" method="POST" action="asearchsresult.php">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="searchword" placeholder="请输入工作人员信息" name="searchword">
                            </div>
                            <button type="submit" class="btn btn-default" id="searchuser"><a href="asearchsresult.php">查找工作人员</a></button>
                        </div>
                    </form>
                </div>
            </div>
